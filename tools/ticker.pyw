...
GECKO_SEC = 60                           # 코인게코 조회 간격(초). 분당 1회면 무료 등급에 안 걸린다.
# 180초로 두니 급등 중인 코인이 앵커를 못 따라갔다(2026-09-03 XRP: 가격 0.48%, 등락률
# 0.71%p 벌어짐. 같은 시각 BTC는 0.14%·0.34%p). 앵커가 낡을수록, 코인이 빠를수록 벌어진다.
